...
namespace Solution_1.Figures
{
    class Rectangle:Figure
    {
        ...
        public Rectangle(double left, double top, double width, double height, uint iD):base(iD)
        {
            Left = left;
            Top = top;
            Width = width;
        ...
        {
            return $"#{ID} {Name}: left = {Left}, top = {Top}, width = {Width}, height = {Height}";
        }
        ...
        /// <summary>
        /// Does a rectangle cross a rectangle
        /// </summary>
        ...
        {
            double thisRight = Left + Width;
            double thisBottom = Top - Height;
        ...
        /// <summary>
        /// Does a rectangle cross a circle
        /// </summary>
